...
ReadPngCallbacks readPngArray [TextureType_Max] = {
    [TextureType_rgba16] = PngTexture_ReadRgba16,
    [TextureType_rgba32] = PngTexture_ReadRgba32,
    [TextureType_i4] = PngTexture_ReadI4,
    [TextureType_i8] = PngTexture_ReadI8,
    [TextureType_ia4] = PngTexture_ReadIA4,
    [TextureType_ia8] = PngTexture_ReadIA8,
    [TextureType_ia16] = PngTexture_ReadIA16,
    [TextureType_ci4] = PngTexture_ReadCI4,
